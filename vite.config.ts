  ...
  build: {
    rollupOptions: {
      input: {
        ...
        chordSing: resolve(__dirname, "chord-sing/index.html"),
        chordQualityId: resolve(__dirname, "chord-quality-id/index.html"),
        chordInversionId: resolve(__dirname, "chord-inversion-id/index.html"),
