...
| TD-015 | P2 | CI | **`tests/`** not typechecked. Lint runs in CI via Biome (`npm run lint`). | Test helpers can drift from domain types. | Extend **`npm run typecheck`** to include `tests/` and fix existing errors. |
